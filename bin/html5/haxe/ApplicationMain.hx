...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("flappy-starling", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("flappy-starling", null, 320, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.gamua.flappy-starling";
